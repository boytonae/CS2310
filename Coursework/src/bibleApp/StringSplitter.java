...
public class StringSplitter
{
	 ...
	 * 
	 * @param allPsalms - All the verses in this particular psalm, and the header, if there is one
	 * @return A Psalm with the correct verses and header. Header is null if there is none
	 */
